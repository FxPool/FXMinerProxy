...
[fxminerproxyv3.zip]:https://github.com/FxPool/FXMinerProxy/releases/download/10.2.3/fxminerproxyv3windows.zip
...
<p align="center">
  <a>
    <img src="https://img.shields.io/badge/Release-10.2.3-orgin.svg" alt="travis">
  </a>
  <a>
    <img src="https://img.shields.io/badge/Last_Update-2023 04 17-orgin.svg" alt="travis">
  </a>
  <a>
...
# FXMinerProxy
Custom charging proxy software for mining pool. Coin support `BTC`, `LTC`, `ZEC`, `ETC`, `ETHF`, `ETHW`, `RVN`, `CFX`, `BEAM`, `ERGO`, `BTG`, `AE`, `FLUX`, `FIRO`, `NEOXA`,`XMR`, `KASPA`, `GRIN`, `KDA`, `DASH`, `CKB`, `RXD`,`ZIL`,`ETHW_ZIL`,`ETHF_ZIL`,`ETC_ZIL`,`KDA`, `DASH`, `CKB` , `ZEN` , `NEXA`, `HNS`, `BCH`   
