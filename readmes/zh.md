...
[fxminerproxyv3.zip]:https://github.com/FxPool/FXMinerProxy/releases/download/13.0.0/fxminerproxyv3windows.zip
...
<p align="center">
  <a>
    <img src="https://img.shields.io/badge/Release-13.0.0-orgin.svg" alt="travis">
  </a>
  <a>
    <img src="https://img.shields.io/badge/Last_Update-2014 01 16-orgin.svg" alt="travis">
  </a>
  <a>
...
- 稳定的版本
  * 外网
  ```shell
  bash <(curl -s -L https://raw.githubusercontent.com/FxPool/FXMinerProxy/main/oldversion/install_zh.sh) 13.0.0
  ```
#### windows系统
- **权限** `administrator`
- **系统支持** `windows8+`
