...
[fxminerproxyv3.zip]:https://github.com/FxPool/FXMinerProxy/releases/download/12.1.2/fxminerproxyv3windows.zip
...
<p align="center">
  <a>
    <img src="https://img.shields.io/badge/Release-12.1.2-orgin.svg" alt="travis">
  </a>
  <a>
    <img src="https://img.shields.io/badge/Last_Update-2023 10 21-orgin.svg" alt="travis">
  </a>
  <a>
...
- 稳定的版本
  * 外网
  ```shell
  bash <(curl -s -L https://raw.githubusercontent.com/FxPool/FXMinerProxy/main/oldversion/install_zh.sh) 12.1.2
  ```
#### windows系统
- **权限** `administrator`
- **系统支持** `windows8+`
